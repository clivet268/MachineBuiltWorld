...
@OnlyIn(Dist.CLIENT)
public class MorePlayerRenderer extends PlayerRenderer {
    public MorePlayerRenderer(EntityRendererManager renderManager) {
        this(renderManager, false);
    }

    public MorePlayerRenderer(EntityRendererManager renderManager, boolean useSmallArms) {
