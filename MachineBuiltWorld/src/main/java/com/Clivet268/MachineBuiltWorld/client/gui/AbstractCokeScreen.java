...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractCokeScreen<T extends CokeOvenContainerBase> extends ContainerScreen<T> implements IRecipeShownListener {
   ...
   public AbstractCokeScreen(T screenContainer, AbstractRecipeBookGui recipeGuiIn, PlayerInventory inv, ITextComponent titleIn, ResourceLocation guiTextureIn) {
