...
public class TBatteryScreen extends ContainerScreen<TBatteryContainer> {

        private ResourceLocation GUI = new ResourceLocation(MachineBuiltWorld.MOD_ID, "textures/gui/tbattery.png");

        public TBatteryScreen(TBatteryContainer container, PlayerInventory inv, ITextComponent name) {
