package com.Clivet268.MachineBuiltWorld.client.renderer.world;
...
//			}
        ...
        bufferbuilder.getVertexBuilder().pos(-1.0D, (double) f19, 1.0D).color(0, 0, 0, 255).endVertex();
        bufferbuilder.getVertexBuilder().pos(1.0D, (double) f19, 1.0D).color(0, 0, 0, 255).endVertex();
        bufferbuilder.getVertexBuilder().pos(1.0D, -1.0D, 1.0D).color(0, 0, 0, 255).endVertex();
        bufferbuilder.getVertexBuilder().pos(-1.0D, -1.0D, 1.0D).color(0, 0, 0, 255).endVertex();
        bufferbuilder.getVertexBuilder().pos(-1.0D, -1.0D, -1.0D).color(0, 0, 0, 255).endVertex();
        bufferbuilder.getVertexBuilder().pos(1.0D, -1.0D, -1.0D).color(0, 0, 0, 255).endVertex();
        bufferbuilder.getVertexBuilder().pos(1.0D, (double) f19, -1.0D).color(0, 0, 0, 255).endVertex();
        ...
        for (int i = 0; i < 3000; ++i) {
            ...
            if (d4 < 1.0D && d4 > 0.01D) {
                ...
                for (int j = 0; j < 4; ++j) {
                    ...
                    bufferBuilder.getVertexBuilder().pos(d5 + d25, d6 + d23, d7 + d26).endVertex();
                }
            }
        }
    }
