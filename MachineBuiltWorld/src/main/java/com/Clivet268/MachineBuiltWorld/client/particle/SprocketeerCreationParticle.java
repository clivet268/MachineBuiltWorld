package com.Clivet268.MachineBuiltWorld.client.particle;
...
public class SprocketeerCreationParticle extends SpriteTexturedParticle {
        private SprocketeerCreationParticle(World worldIn, double xCoordIn, double yCoordIn, double zCoordIn) {
        ...
        public static class Factory implements IParticleFactory<BasicParticleType> {
            ...
            public Particle makeParticle(BasicParticleType typeIn, World worldIn, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
                SprocketeerCreationParticle lavaparticle = new SprocketeerCreationParticle(worldIn, x, y, z);
