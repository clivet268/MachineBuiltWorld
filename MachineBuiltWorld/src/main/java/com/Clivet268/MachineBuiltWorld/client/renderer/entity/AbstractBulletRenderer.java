...
@OnlyIn(Dist.CLIENT)
public abstract class AbstractBulletRenderer<T extends AbstractBulletEntity> extends EntityRenderer<T> {

        public AbstractBulletRenderer(EntityRendererManager renderManagerIn) {
