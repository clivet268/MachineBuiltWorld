...
public class MillScreen extends ContainerScreen<MillContainer> {
        ...
        private ResourceLocation GUI = new ResourceLocation(MachineBuiltWorld.MOD_ID, "textures/gui/mill.png");

        public MillScreen(MillContainer container, PlayerInventory inv, ITextComponent name) {
