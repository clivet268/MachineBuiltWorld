...
//TODO make sickly
public class SickShotEntity extends AbstractSickShotEntity {
    ...
    public SickShotEntity(EntityType<SickShotEntity> type, World worldIn) {
        super(type, worldIn);
    }

    public SickShotEntity(World worldIn, double x, double y, double z) {
        super(RegistryHandler.SICK_SHOT_ENTITY.get(), x, y, z, worldIn);
    }

    public SickShotEntity(World worldIn, LivingEntity shooter) {
        super(RegistryHandler.SICK_SHOT_ENTITY.get(), shooter, worldIn);
    }
