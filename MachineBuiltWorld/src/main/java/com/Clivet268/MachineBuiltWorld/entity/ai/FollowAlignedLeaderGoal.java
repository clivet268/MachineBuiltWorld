...
public class FollowAlignedLeaderGoal extends Goal {
        ...
        public FollowAlignedLeaderGoal(MachineEntity p_i225711_1_, double p_i225711_2_, float p_i225711_4_, float p_i225711_5_, boolean p_i225711_6_) {
            ...
            if (!(p_i225711_1_.getNavigator() instanceof GroundPathNavigator) && !(p_i225711_1_.getNavigator() instanceof FlyingPathNavigator)) {
                throw new IllegalArgumentException("Unsupported mob type for FollowAlignedLeaderGoal");
            }
        }
