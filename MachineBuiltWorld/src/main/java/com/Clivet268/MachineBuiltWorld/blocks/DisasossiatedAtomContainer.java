...
import com.Clivet268.MachineBuiltWorld.tileentity.DisassociatedAtomContainerTile;
...
public class DisasossiatedAtomContainer extends Block{
   ...
   public DisasossiatedAtomContainer(){
    ...
    public TileEntity createTileEntity(BlockState state, IBlockReader world) {
        return new DisassociatedAtomContainerTile().getTileEntity();
    }
