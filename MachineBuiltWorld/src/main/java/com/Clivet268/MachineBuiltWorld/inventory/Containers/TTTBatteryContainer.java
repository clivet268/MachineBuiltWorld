...
public class TTTBatteryContainer extends Container {
    private TileEntity tileEntity;
    private PlayerEntity playerEntity;
    private IItemHandler playerInventory;

    public TTTBatteryContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(TTTBATTERY_CONTAINER.get(), windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
       // ItemStack itemstack = playerIn.inventory.offHandInventory.stream().findFirst().get();
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity,
                TTTBATTERY.get()) && playerIn.getHeldItemMainhand().getItem() == MULTIMETER.get();
    }
