...
public abstract class AbstractMillContainer extends RecipeBookContainer<IInventory> {
    private final IInventory furnaceInventory;
    private final IIntArray furnaceData;
    public final World world;
    private IItemHandler playerInventory;
    public MillTile tileEntity;


    private final IRecipeType<? extends AbstractMillingRecipe> recipeType;
    public AbstractMillContainer(ContainerType<?> containerTypeIn, World wworld, IRecipeType<? extends AbstractMillingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, BlockPos pos) {
        this(containerTypeIn, wworld, recipeTypeIn, id, playerInventoryIn, new Inventory(2), new IntArray(5),pos);
    }

    protected AbstractMillContainer(ContainerType<?> containerTypeIn, World wworld, IRecipeType<? extends AbstractMillingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, IIntArray furnaceDataIn, BlockPos pos) {
        super(containerTypeIn, id);
        this.world = wworld;
        this.tileEntity = (MillTile) wworld.getTileEntity(pos);
    ...
    protected boolean hasRecipe(ItemStack stack) {
        return this.world.getRecipeManager().getRecipe((IRecipeType<MillingRecipe>)this.recipeType, new Inventory(stack), this.world).isPresent();
    }
