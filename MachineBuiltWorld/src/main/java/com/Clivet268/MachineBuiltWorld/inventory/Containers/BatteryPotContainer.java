...
public class BatteryPotContainer extends Container {
    private TileEntity tileEntity;
    private PlayerEntity playerEntity;
    private IItemHandler playerInventory;

    public BatteryPotContainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(BATTERY_POT_CONTAINER.get(), windowId);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        ...
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()), playerEntity,
                BATTERY_POT.get()) && playerIn.getHeldItemMainhand().getItem() == MULTIMETER.get();
