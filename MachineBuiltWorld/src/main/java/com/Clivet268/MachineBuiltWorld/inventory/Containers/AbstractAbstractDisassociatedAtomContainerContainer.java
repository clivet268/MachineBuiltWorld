...
public abstract class AbstractAbstractDisassociatedAtomContainerContainer extends RecipeBookContainer<IInventory> {
    ...
    public AbstractAbstractDisassociatedAtomContainerContainer(ContainerType<?> containerTypeIn, World wworld, IRecipeType<? extends AbstractCokeingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, BlockPos pos) {
        this(containerTypeIn, wworld, recipeTypeIn, id, playerInventoryIn, new Inventory(4), new IntArray(4),pos);
    }

    protected AbstractAbstractDisassociatedAtomContainerContainer(ContainerType<?> containerTypeIn, World wworld, IRecipeType<? extends AbstractCokeingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, IIntArray furnaceDataIn, BlockPos pos) {
