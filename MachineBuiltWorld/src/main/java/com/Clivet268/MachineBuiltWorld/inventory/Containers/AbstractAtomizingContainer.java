...
public abstract class AbstractAtomizingContainer extends RecipeBookContainer<IInventory> {
    ...
    public AbstractAtomizingContainer(ContainerType<?> containerTypeIn, World wworld, IRecipeType<? extends AbstractCrushingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, BlockPos pos) {
        this(containerTypeIn, wworld, recipeTypeIn, id, playerInventoryIn, new Inventory(4), new IntArray(5),pos);
    }

    protected AbstractAtomizingContainer(ContainerType<?> containerTypeIn, World wworld, IRecipeType<? extends AbstractCrushingRecipe> recipeTypeIn, int id, PlayerInventory playerInventoryIn, IInventory furnaceInventoryIn, IIntArray furnaceDataIn, BlockPos pos) {
        ...
        if (tileEntity != null) {
            ...
            addSlot(new Slot(this.tileEntity, 1, 56, 17));
    ...
    protected boolean hasRecipe(ItemStack stack) {
        return this.world.getRecipeManager().getRecipe((IRecipeType<CrushingRecipe>)this.recipeType, new Inventory(stack), this.world).isPresent();
    }
