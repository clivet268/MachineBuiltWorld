...
names = ["gold", "copper", "iron","diamond"]
directions = ["east", "west", "south", "north"]

for openn in openness:
    for direction in directions:
        original = '/home/clivet268/Clives Mods/MachineBuiltWorld/src/main/resources/assets/machinebuiltworld/models/block/crusher'+ openn + direction + 'steel.json'
        ...
        for name in names:
            ...
            with open('/home/clivet268/Clives Mods/MachineBuiltWorld/src/main/resources/assets/machinebuiltworld/models/block/crusher' + openn + direction + name + '.json', "w") as file:
